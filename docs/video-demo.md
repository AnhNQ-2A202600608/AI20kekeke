...
- 16:9 screen recording or edited product video.
- 90-120 seconds for the main Demo Day cut.
- YouTube upload can be unlisted.
- Final link should be placed in this file and in the README deliverables table.
...
1:50-2:00  Closing: course-grounded AI tutor for learners who need to understand, not copy.
```

## Final Video Link

Google Drive: https://drive.google.com/file/d/1NQ1dr-2m2TQ66HDeC4GEyFl4EkKxwW2p/view?usp=drive_link
