...
The previous combined canvas `docs/diagram/edugap-system-diagrams.excalidraw` has been replaced by one file per chart so each system diagram can be edited and exported independently.
