import json
import pytest
from src.pipeline.graphusion.normalize_concepts import normalize_and_deduplicate, clean_vietnamese_text
from src.pipeline.graphusion.validate_graph import validate_prerequisite_dag, validate_full_graph, check_evidence_in_chunk
