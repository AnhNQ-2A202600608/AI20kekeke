...
-- -------------------------------------------------------------------------
-- 1. Bổ sung ràng buộc weight cho concept_relations
-- -------------------------------------------------------------------------
ALTER TABLE app.concept_relations DROP CONSTRAINT IF EXISTS weight_range_check;
ALTER TABLE app.concept_relations ADD CONSTRAINT weight_range_check CHECK (weight >= 0.0 AND weight <= 1.0);

-- -------------------------------------------------------------------------
-- 2. Kích hoạt RLS & Policies cho concept_relations
-- -------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------
-- 3. Kích hoạt RLS & Policies cho student_concept_mastery
-- -------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------
-- 4. Định nghĩa RPC submit_attempt_v3 nguyên tử gộp lan truyền BKT
-- -------------------------------------------------------------------------
