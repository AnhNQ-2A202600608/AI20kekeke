...
ALTER TABLE app.student_concept_mastery
  ADD COLUMN IF NOT EXISTS stability_days DECIMAL NOT NULL DEFAULT 3.0;

-- -------------------------------------------------------------------------
-- Update RPC submit_attempt_v3 to support stability_days
-- -------------------------------------------------------------------------
