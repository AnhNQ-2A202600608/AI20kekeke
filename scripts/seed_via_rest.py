...
def seed_data():
    ...
    concepts = [
        ...
        ("00000000-0000-0000-0000-000000000104", "prompt-context-foundations", "Day 4: Prompt Engineering & Tool Calling"),
        ("00000000-0000-0000-0000-000000000105", "ai-product-uncertainty-foundations", "Day 5: Thiết kế sản phẩm AI cho sự không chắc chắn"),
        ...
        ("00000000-0000-0000-0000-000000000108", "day8-basics", "Day 8: RAG Pipeline - Retrieval — Augmentation — Generation"),
