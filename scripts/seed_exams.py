...
CONCEPT_MAPPING = {
    ...
    "midterm-observability": "d23-t2-observability-stack",
...
def main():
    ...
    exam_sets = [s for s in manifest.get("sets", []) if s.get("parent_id") == "midterm-review" and "short-answer" not in s.get("id", "")]
