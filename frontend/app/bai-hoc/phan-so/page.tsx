    ...
    <AppShell compact>
      <div className="lesson-page">
        ...
        <article className="lesson-content">
          ...
          <div className="lesson-actions"><button type="button" onClick={() => setActive(Math.max(0, active - 1))}>← Phần trước</button><Link className="primary-action" href="/luyen-tap">Luyện tập bài học này<span>→</span></Link></div>
        </article>
      </div>
    </AppShell>
  );
