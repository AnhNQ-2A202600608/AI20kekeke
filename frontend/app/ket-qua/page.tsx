...
export default function ResultPage() {
  return (
    <Suspense fallback={<div className="p-6 text-center text-muted">Đang tải kết quả...</div>}>
      <AppShell compact>
        <ResultPageContent />
      </AppShell>
    </Suspense>
