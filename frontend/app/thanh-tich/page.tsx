...
const badges = [
  ...
  { code: "XP", title: "Nhà thám hiểm", desc: "Tích lũy 1.500 XP ở cấp Explorer", earned: true },
...
export default function AchievementsPage() {
  return (
    <AppShell>
      <section className="achievement-head"><div><span className="overline">Hồ sơ thành tích</span><h1>Mỗi bước tiến đều đáng được ghi nhận.</h1><p>Điểm kinh nghiệm, huy hiệu và thứ hạng của bạn trong nhóm cùng trình độ.</p></div><div className="achievement-level level-explorer-bg"><LevelBadge level="explorer"/><strong>Cấp 8</strong><span>1.840 / 2.400 XP</span><ProgressBar value={77}/></div></section>
