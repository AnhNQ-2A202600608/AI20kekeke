...
Để đánh giá đúng mức độ hiểu bài thay vì khả năng học vẹt, hệ thống tự động thiết kế các câu hỏi có tính phân hóa cao. EduGap áp dụng phương pháp **Evol-Instruct** của bài báo **[WizardLM](/docs/academic-citations#7-wizardlm-evol-instruct-instruction-complication)** nhằm nâng cao độ phức tạp và tính thực tiễn của ngân hàng câu hỏi.
