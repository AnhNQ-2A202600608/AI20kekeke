...
description: "Next.js App Router, Supabase SSR, BFF proxy, Zustand state và docs MDX runtime của Mentora."
---

Mentora frontend is a Next.js App Router application. It owns the public landing page, authentication pages, onboarding, student learning workspace, quiz experience, profile, mentor/admin surfaces and the MDX documentation site.
