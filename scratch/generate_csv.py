...
rows = [
    ...
    [
        ...
        "Học viên mở Mentora; giao diện sáng, sạch, rõ ràng. Đặc biệt: Cáo Sofi 3D hoạt họa bay ra từ màn hình laptop, lượn một vòng lấp lánh quanh học viên A rồi đáp nhẹ lên bàn học, nháy mắt mỉm cười.",
        "Quay qua vai lúc mở Mentora; chèn screen recording dashboard/trang học. Quay cận cảnh Cáo Sofi bay lượn và biểu cảm thích thú của học viên.",
        "Cho đến khi tôi biết tới Mentora – hệ thống gia sư AI cá nhân hóa thiết kế riêng cho bài học của lớp. Và đây là Sofi – trợ lý AI đồng hành thông thái, người sẽ không để tôi cô độc trên con đường học tập.",
        ...
        "Dashboard/trang học Mentora, logo, mô hình Cáo Sofi 3D."
    ],
    [
        "5",
        "0:55-1:18",
        ...
        "Mentora chat: học viên hỏi một khái niệm trong bài; Mentora trả lời bằng gợi ý từng bước và citation.",
        ...
        "Mentora chat, câu hỏi ngắn, câu trả lời dạng hint, citation card."
    ],
    [
        "6",
        "1:18-1:35",
        "Luyện tập - Học bằng làm bài",
        "Show Mentora không chỉ là chat, mà có vòng luyện tập.",
    ...
    [
        ...
        "Logo Mentora; học viên tiếp tục học bình tĩnh; có thể overlay UI đẹp nhất hoặc Sofi nhỏ.",
        "Medium shot học viên; end card logo; có QR placeholder nếu cần.",
        "Mentora giúp tôi học cùng AI mà không đi đường tắt, thực sự tự tin làm chủ con đường học tập của chính mình.",
