...
### 1.1. Giới thiệu Mentora
**Mentora (AI20K-C2-HE-01)** là một hệ thống **Adaptive-first AI Tutor** (Gia sư AI thích ứng) dành cho môi trường giáo dục đại học quy mô lớn. 
...
Mentora sử dụng bộ 4 thuật toán lõi được tích hợp chặt chẽ tại FastAPI Backend (`src/services/adaptive/`):
